...
Пиши как человек в обычной рабочей переписке: «Добрый день!», «Нужен…»,
«Подскажите, есть такой в наличии и сколько стоит…». Без «просим предоставить»,
«требуется», канцелярских оборотов и искусственной фамильярности. Затем точные характеристики, количество,
